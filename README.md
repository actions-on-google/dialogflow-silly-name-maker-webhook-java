# Actions on Google: Silly Name Maker Sample using Java Client Library

This is a super simple Assistant app, built using Dialogflow and Java Client Library, to
...
#### Build for AWS
    ...
    1. Deploy the zip file found at `build/distributions/silly-name-maker-java.zip` as an AWS Lambda function by following instructions at https://aws.amazon.com/lambda/
